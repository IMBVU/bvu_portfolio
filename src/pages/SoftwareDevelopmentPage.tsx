...
const features = [
  ...
  },
  {
    ...
    description: "Creating optimized database schemas and query patterns",
    icon: Database,
    color: "from-amber-500/20 to-orange-500/20 dark:from-amber-500/10 dark:to-orange-500/10"
  },
  {
    title: "API Development",
    description: "Building robust and secure RESTful and GraphQL APIs",
    icon: Code,
      ...
      <div className="max-w-7xl mx-auto px-4 py-20">
        ...
        >
          ...
          <p className="text-xl text-gray-600 dark:text-gray-400">
            Creating robust and scalable software solutions with modern technologies 
            and best practices.
          </p>
        </motion.div>
